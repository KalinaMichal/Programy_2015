...
void __fastcall TForm1::Otwrz1Click(TObject *Sender)
{
      ...
      nazwapliku = Okno->FileName;
            ...
            {
             ShowMessage("B³¹d otwarcia pliku. Upewnij siê, ¿e plik istnieje na tym dysku  :)");
            }
...
void __fastcall TForm1::Zapiszjako1Click(TObject *Sender)
{
    if (Saveplik->Execute())
      ...
      nazwapliku = Saveplik->FileName;
            ...
            {
             ShowMessage("Zapis zakoñczy³ siê niepowodzeniem!!! :/ niestety");
            }
...
{
if(Application->MessageBox("Czy napewno chcesz utworzyæ nowy plik i zacz¹æ wszystko od nowa? NAPEWNO!? :O","PotwierdŸ",
...
{
if(Application->MessageBox("Czy napewno chcesz zakoñczyæ program!? ","PotwierdŸ",
